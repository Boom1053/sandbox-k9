        ...
        options = {
          {
            ...
            icon = "paw",
            label = "PD K9 Unit",
            event = "sandbox-k9:client:menu",
            job = Config.K9.job,
            distance = 3.0,
          },
        },
      })
    elseif Config.K9.target == "sandbox" then
...
RegisterNetEvent('sandbox-k9:client:menu', function()
  local K9Purchase = {
    main = {
  ...
  table.insert(K9Purchase.main.items, {
    ...
    event = "sandbox-k9:client:PurchaseDog"
  })

  table.insert(K9Purchase.main.items, {
    label = "🐕 | Return K9",
    description = "Here you can return one of the department's K9 Dogs",
    event = "sandbox-k9:client:ReturnDoggo"
  })

  ListMenu:Show(K9Purchase)
end)

RegisterNetEvent('sandbox-k9:client:ReturnDoggo', function()
  if k9_id then
    DespawnK9()
...
RegisterNetEvent('sandbox-k9:client:PurchaseDog', function()
  if k9_id then
    DespawnK9()
  ...
  for k, v in pairs(Config.K9.DogModelProps) do
    table.insert(K9DogsMenu.main.items, {
      ...
      event = "sandbox-k9:client:SpawnHandler",
      data = {
        model = v.Dog,
        colour = v.Colour,
        vest = v.Vest
...
RegisterNetEvent('sandbox-k9:client:SpawnHandler', function(data)
...
function RegisterKeyBinds()
  Keybinds:Add('caninecommanders', Config.K9.K9KeyCommands, 'keyboard', 'Police - K9 Commands', function()
    TriggerEvent('sandbox-k9:client:CommandsMenu')
  end)
  Keybinds:Add('cannineattackfollow', Config.K9.K9KeyFollowAttack, 'keyboard', 'Police - K9 Follow / Attack', function()
    TriggerEvent('sandbox-k9:client:Commands', { action = 'followAttack' })
  end)
end

RegisterNetEvent('sandbox-k9:client:CommandsMenu', function()
  ...
  for _, command in ipairs(commandOptions) do
    table.insert(k9CommandsMenu.main.items, {
      ...
      event = "sandbox-k9:client:Commands",
...
RegisterNetEvent('sandbox-k9:client:Commands', function(data)
